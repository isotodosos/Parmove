...
<head>
    ...
    <title>Alquila lo que necesites</title>
...
<main class="contenidoBuscadorG">
    ...
    <section class="tableroCromos row">
       ...
       <div class="cromosBG col-12 row">
            <a href="seleccionado.php?car=<?php echo $filaFiltroG["id_vehiculo"]; ?>&yo=<?php echo $_SESSION["id"];?>" class="col-12 row" >
